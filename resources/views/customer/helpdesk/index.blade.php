        ...
        <div class="max-w-full mx-auto">
            <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                  ...
                  <p class="mt-2 text-sm text-gray-400">คุณสามารถเพิ่มรายการแจ้งซ่อม  หรือดูรายการแจ้งซ่อมของตัวเองได้</p>
                </div>
                  ...
                  <tbody class="divide-y divide-white/5">
                    ...
                    <tr>
                        ...
                        <td class="hidden py-4 pl-0 pr-4 text-right text-sm leading-6 text-gray-400 sm:table-cell sm:pr-6 lg:pr-8">
                          <a href="{{ route('helpdesk.edit',$item->id) }}">
                        ...
                        <td class="hidden py-4 pl-0 pr-4 text-right text-sm leading-6 text-gray-400 sm:table-cell sm:pr-6 lg:pr-8">
                          <a href="{{ route('helpdesk.show',$item->id) }}">
                            <button type="button" class="inline-flex items-center gap-x-2 rounded-md bg-violet-600 px-2.5 py-1.5 text-sm font-semibold text-white shadow-sm hover:bg-violet-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-violet-600">
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="-ml-0.5 h-5 w-5">
