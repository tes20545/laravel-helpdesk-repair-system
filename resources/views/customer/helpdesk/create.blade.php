            ...
            <form>
                <div class="space-y-12">
                        ...
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="col-span-full">
                                ...
                                <div class="mt-2 flex items-center gap-x-3">
                                    <svg class="h-12 w-12 text-gray-500" viewBox="0 0 24 24" fill="currentColor"
                                        aria-hidden="true">
                    ...
                    <div class="border-b border-white/10 pb-12">
                        ...
                        <p class="mt-1 text-sm leading-6 text-gray-400">We'll always let you know about important
                        ...
                        <div class="mt-10 space-y-10">
                                ...
                                <div class="mt-6 space-y-6">
                                    ...
                                    <div class="relative flex gap-x-3">
                                        ...
                                        <div class="text-sm leading-6">
                                            ...
                                            <p class="text-gray-400">Get notified when a candidate accepts or rejects
                                                an offer.</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <fieldset>
                                ...
                                <p class="mt-1 text-sm leading-6 text-gray-400">These are delivered via SMS to your
                                    mobile phone.</p>
                                <div class="mt-6 space-y-6">
                                    ...
                                    <div class="flex items-center gap-x-3">
                                        ...
                                        <label for="push-email"
                                            class="block text-sm font-medium leading-6 text-white">Same as
                                            email</label>
                                    </div>
                                    <div class="flex items-center gap-x-3">
                                        ...
                                        <label for="push-nothing"
                                            class="block text-sm font-medium leading-6 text-white">No push
                                            notifications</label>
                                    </div>
                                </div>
                            </fieldset>
