                ...
                <table class="mt-6 w-full whitespace-nowrap text-left">
                  ...
                  <thead class="border-b border-white/10 text-sm leading-6 text-white">
                    <tr>
                      ...
                      <th scope="col" class="py-2 pl-0 pr-4 text-right font-semibold sm:pr-8 sm:text-left lg:pr-20">สถานะบัญชี</th>
                      <th scope="col" class="hidden py-2 pl-0 pr-8 font-semibold md:table-cell lg:pr-20">สิทธิ์การเข้าถึง</th>
                        ...
                        @if($user->deleted_at == null)
                          <td class="py-4 pl-0 pr-4 text-sm leading-6 sm:pr-8 lg:pr-20">
                            <div class="flex items-center justify-end gap-x-2 sm:justify-start">
                              ...
                              <div class="hidden text-white sm:block">ใช้งาน</div>
                            </div>
                          </td>
                        @else
                          <td class="py-4 pl-0 pr-4 text-sm leading-6 sm:pr-8 lg:pr-20">
                            <div class="flex items-center justify-end gap-x-2 sm:justify-start">
                              ...
                              <div class="hidden text-white sm:block">ปิดการใช้งาน</div>
                            </div>
                          </td>
                        @endif
